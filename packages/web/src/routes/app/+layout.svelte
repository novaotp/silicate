...
<div class="relative h-full w-full flex flex-col md:flex-row dark:bg-neutral-950">
    ...
    <div class="relative {showMenu ? "md:w-[calc(100%-200px)]" : "md:w-[calc(100%-80px)]"} duration-300 ease-in-out h-[calc(100%-60px)] md:shadow-[-2px_0_4px_4px_rgba(0,0,0,0.1)] dark:shadow-none md:h-full flex flex-col">
        <slot />
    </div>
</div>
