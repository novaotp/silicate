...
<main class="relative flex h-full w-full flex-col justify-center bg-white p-8 gap-5">
    <h1 class="text-5xl font-extrabold text-primary-600">{APP_NAME}</h1>
    ...
    <p class="text-justify text-neutral-500">
        Tu es étudiant et submergé par les devoirs, les cours et les dates limites ? Pas de soucis ! Avec {APP_NAME}, organise-toi en un clin d'œil et
    ...
    <div class="relative flex flex-col gap-3 mt-8">
        <a class="relative w-full rounded-lg p-3 text-center bg-primary-600 text-primary-50" href="/register">
            Inscris-toi
        </a>
        <span
        ...
        <a class="relative w-full rounded-lg bg-bg-color p-3 text-center bg-primary-50 text-primary-600 border border-primary-600" href="/login">
            Se connecter
        </a>
    </div>
</main>
