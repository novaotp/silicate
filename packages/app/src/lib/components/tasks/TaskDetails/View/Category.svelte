<script lang="ts">
    ...
    import { getCategories, getTasks, updateCategory } from '$/lib/requests/tasks';
    ...
    $: categorySearchParam = urlSearchParams.get('category') ?? '';
    ...
    const editCategory = async () => {
        ...
        const { success, message }: ApiResponse = await updateCategory(id, category);
        ...
        const updatedTaskResults = await getTasks(categorySearchParam, search, archivedSearchParam);
