...
export const createGrade = async ({
    ...
    try {
        ...
        const now = new Date();
        const query =
            "INSERT INTO public.grade (user_id, subject_id, name, score, weight, comment, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)";
        const values = [
            userId,
            subjectId,
            name,
...
export const updateGrade = async ({
    ...
    try {
        ...
        const now = new Date();
        const query =
            "UPDATE public.grade SET name = $1, score = $2, weight = $3, comment = $4, updated_at = $5 WHERE user_id = $6 AND subject_id = $7 AND id = $8";
        const values = [
            name,
            score,
            weight,
...
export const deleteGrade = async (
    ...
    try {
        ...
        const query =
            "DELETE FROM public.grade WHERE id = $1 AND user_id = $2 AND subject_id = $3";
