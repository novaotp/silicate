...
class FriendsEndpoints {
    ...
    static async create(req, res) {
        ...
        try {
            ...
            const addFriendQuery =
                "INSERT INTO public.friendship (first_user_id, second_user_id) VALUES ($1, $2)";
    ...
    static async readAll(req, res) {
        ...
        try {
            ...
            const addFriendQuery =
                "SELECT * FROM public.friendship WHERE first_user_id = $1 OR second_user_id = $1;";
    ...
    static async delete(req, res) {
        ...
        try {
            ...
            const removeFriendQuery =
                "DELETE FROM public.friendship WHERE first_user_id = $1 AND second_user_id = $2";
