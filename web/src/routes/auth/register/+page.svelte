...
<form
    method="POST"
    class="relative mb-5 flex w-[70%] flex-col overflow-x-hidden xl:hidden"
	use:enhance
>
    <Switcher>
...
<form
    method="POST"
    class="relative mb-5 w-[70%] flex-col justify-center items-center overflow-x-hidden hidden xl:flex"
>
