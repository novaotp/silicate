...
const Page = (): JSX.Element => {
  return (
    <div className="relative w-full h-full flex flex-col justify-center bg-[bg-color] p-8">
      <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 from-30% to-indigo-200 bg-clip-text">Silicate</h1>
      <h2 className="text-justify text-xl text-text-color my-4 font-semibold">L'appli pour gérer ta vie scolaire facilement</h2>
